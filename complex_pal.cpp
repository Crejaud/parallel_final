...
void get_all_substrings_seq(string);
void get_all_substrings_par(string, int);
void get_all_substrings_par_thread(string, int, int);
void find_palindromes_of_anagrams(string, int);
void find_palindromes_of_anagrams_par_loop(int);
...
int main() {
  ...
  get_all_substrings_par(word, num_threads);
  ...
  find_palindromes_of_anagrams_par_loop(num_threads);
...
void get_all_substrings_par(string word, int num_threads) {
  int i, j;
